...
<jsp:setProperty name="bbs" property="search" param="search"/>
...
%>
		...
		%>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
						aria-expanded="false"><font color="red"> |</font> [<%=userID %>]  님 환영합니다 <font color="red">|</font> 
...
<br>
	...
	<div class="container">
	    <!-- 검색창 -->
			<form class="navbar-form navbar-right" action="search.jsp">
			 <div class="form-group">
			  <input type="text" name="search"class="form-control" placeholder="작성자 를 입력하세요." size="12">
			 </div>
		...
		<!-- 게시판 Start -->
			...
			<div class="row">
				<table class="table table-striped"
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="view2.jsp?bbsID=<%=list2.get(i).getBbsID()%>"><%=list2.get(i).getBbsTitle()%></a></td>
							<td><%=list2.get(i).getUserID()%></td>
							<td><%=list2.get(i).getBbsDate().substring(0, 11) + list2.get(i).getBbsDate().substring(11, 13) + "시"
							+ list2.get(i).getBbsDate().substring(14, 16) + "분"%></td>
						</tr>	
						<%
							}
						%>
				...
				%>
				<a href="#="
					class="btn btn-danger btn-arrow-left">페이지 : <%=pageNumber %></a>
				<!-- 회원만넘어가도록 -->
				<%
				...
				<button class="btn btn-primary pull-right"
					onclick="if(confirm('로그인 하세요'))location.href='LoginForm.jsp';"
