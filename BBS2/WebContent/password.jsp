		...
		<div class="col-lg-4">
			...
			<div class="jumbotron" style="padding-top: 20px;">
				...
				<form method="post" action="mypageAction.jsp">
					<h3 style="text-align: center;"><font color="green">비밀번호 변경</h3><br></font>
					...
					<div class="form-group">
						<input type="password" placeholder="새 비밀번호" name="userNewPassword" class="form-control" maxlength="20">
					</div>
					<div class="form-group">
						<input type="password" class="form-control" placeholder="새 비밀번호 확인"
							name="userNewPassword" maxlength="20" class="form-control">
					</div>
