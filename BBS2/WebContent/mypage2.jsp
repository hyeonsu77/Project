    ...
    <br>
 			...
 			<div class="row text-center" style="width: 100% ">
                 <div style="width: 20%; float:none; margin:0 auto" >
                    <button class="btn btn btn-danger btn-lg" style="width: 100%">회원정보 수정</button>
                 <div>
                 </div>
           </div>
    	   </div>
    	   <br>
 			<div class="row text-center" style="width: 100%">
                 <div style="width: 20%; float:none; margin:0 auto" >
                   <a href="password.jsp"><button class="btn btn btn-danger btn-lg" style="width: 100%">비밀번호 변경</button></a>
                 <div>
                 </div>
           </div>
    	   </div>
    	    <br>
 			<div class="row text-center" style="width: 100%">
                 <div style="width: 20%; float:none; margin:0 auto" >
                   <a href="userdelete.jsp"><button class="btn btn btn-danger btn-lg" style="width: 100%">회원탈퇴</button></a>
                 <div>
                 </div>
           </div>
    	   </div>
    	   ...
    	   <div class="row text-center" style="width: 100%">
                 <div style="width: 20%; float:none; margin:0 auto" >
                    <button class="btn btn btn-danger btn-lg" style="width: 100%">추천하기</button>
                 <div>
                 </div>
           </div>
    	   </div>
    	   ...
    	   <div class="row text-center" style="width: 100%">
                 <div style="width: 20%; float:none; margin:0 auto" >
                    <button class="btn btn btn-danger btn-lg" style="width: 100%">더보기</button>
                 <div>
                 </div>
           </div>
    	   </div>
    	   ...
    	   <div class="sectionwrap">
            <div class="section">
                <div class="sub_cont">
                    <div class="dbi_cont">
                        <p class="dbi_tit">MyPage</p>
                        <p class="dbi_tex">사용자의 정보 변경을 할 수 있습니다.<br /> 웹어플리케이션진단, 국가 주요정보통신 기반시설 취약점 분석/평가, 개인정보보호교육
                  </div>
                </div>
            </div>
        </div>
