		...
		<!-- 게시판 Start -->
			<div class="row">
				<table class="table table-striped"
					...
					<thead>
						<tr>
							...
							<th style="background-color: #eeeeee; text-align: center;">게시글 관리</th>
						</tr>
					</thead>
					<tbody>
						<%
						...
						<tr>
							...
							<td><input type=button value=삭제 onClick="location.href='AdminBbsDelete.jsp?bbsID=<%=list.get(i).getBbsID()%>'"></td>
						</tr>	
						<%
							}
						%>
				...
				<button class="btn btn-success pull-right"
					onclick="if(confirm('로그인 하세요'))location.href='loginForm3.jsp';"
