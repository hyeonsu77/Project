...
<body class="page-template-default page page-id-12">
	<div id="wrapper">
			<div id="header_wrap">
					<div class="header">
							<h1><a href="main.jsp"><img src="https://www.somansa.com/wp-content/themes/somansa/images/logo.jpg" alt="" class="logo"></a></h1>
							<p class="mMeun_btn">
								<span></span>
							</p>
							<div id="m_bg"></div>
							<ul class="nav">
									...
									<li><a href="consulting.jsp">컨설팅</a></li>
									...
									<li><a href="/introduce/ceo/">회사소개</a>
							</ul>
					</div>
			</div>
			<!--header_wrap-->
...
<div class="section_wrap">
	...
	<div class="section">
        <div class="sub_cont">
			<div class="dbi_cont">
            	<p class="dbi_tit">17년간 1위, <br>외산대비 30%이상 성능향상 악성코드, SSL/TLS 기반 유해사이트 차단 솔루션 <br>WebKeeper Secure Gateway</p>
            </div>
        </div>
    </div>		
</div>
...
<div class="sectionwrap bg_gray02">
            <div class="section">
                <div class="sub_cont">
                    <div class="dbi_cont">
                        <div class="blue_box">
                            <p>귀사가 세이프 브라우징을 하지 않으면 얼마를 손해보는지 계산해보십시오</p>
                        </div>
                        <div class="white_box white_box03">
                            <div>
                                <p>개직원 1천명, 평균월급 3백만원, 하루 8시간 근무기업에서 모든직원이 하루에 10분씩 비업무사이트에 접속한다면 손해비용은연 7억 6천 3백만원입니다. 악성코드감염으로 기밀정보가 유출된다면, 손해비용은 무한대로 늘어나게 됩니다.
                                </p>
                            </div>
                        </div>
                        <div class="blue_box">
                            <p>7년간 유해사이트<br>4,100만 회 보안업데이트<br>5년간 악성코드 <br>2,700만회 보안업데이트</p>
                            <p>
                               </p>
                        </div>
                        <div class="white_box white_box03">
                            <div>
                                <ul>
                                    <li>악성코드사이트 암호화웹사이트 비업무사이트 및 넷앱스 등 유해사이트를 2010년부터 2017년까지 8년간 총 6,800만 회<br> 보안업데이트하였습니다. 악성코드는 2012년부터 2017년까지 6년 연속 총 6,400만 회 보안업데이트하였습니다. 30분 간격 보안업데이트<br>, 일 1회 ‘웹키퍼 악성코드 데일리 카톡’, 주 1회 ‘웹키퍼 위클리’, 연 1회 ‘웹키퍼 애뉴얼’ 등 보안업데이트<br> 공시시스템과 악성코드분석센터운영, 1000여개 고객사를 통한 자동수집/분석시스템 등 6년간 구축해온 국내최대 인프라를 <br>통해 가장 빠르고 정확한 보안업데이트 내역을 고객들에게 제공하고 있습니다</li>
                                </ul>
                            </div>
                        </div>
                        <div class="blue_box">
                            <p>웹트래픽의 72%는 SSL/TLS!<br>SSL/TLS 가시성 확보를 통한 악성코드/유해사이트 접속차단</p>
                        </div>
                        <div class="white_box white_box03">
                            <div>
                                <ul>
                                    <li>웹키퍼는 웹프록시를 이용해 SSL/TLS 가시성 확보 및 복호화를 통한 악성코드/유해사이트 접속을 차단합니다. <br>구글서비스는 웹메일, 드라이브는 차단하고 캘린더, 검색기능은 허용합니다. 구글번역기를 통한 악성코드/유해사이트<br> 우회접속을 차단합니다. 페이스북 계정별 차단이 가능해 도박, 음란 등 불법/유해계정은 차단하고 회사홍보페이지 접속은 <br>허용할 수 있습니다.<br /> 소만사는 자동화된 분석툴로 웹서비스를 통한 DB내 개인정보 과다조회를 정확하게 컨설팅 할 수 있는 유일한 회사입니다.
                                    </li>
                                </ul>
                            </div>
                        </div>
          ...
          <div>
            <p>1천개 고객사로부터<br/> 한국인이 접속하는<br/> 비업무사이트 수집, 차단</p>
          </div>
          <div>
            <p>30분 간격으로<br/> 모든 사이트의 악성코드<br/> 감염여부 점검, 차단</p>
          </div>
          <div>
            <p>기획단계부터 세이프 브라우징 솔루션과<br/> 일체화 설계로 실제상황에서 외산대비<br/> 패킷처리성능이 30%이상 향상 </p>
          </div>
        </div>
                        ...
                        <div class="white_box white_box03">
                            <div>
                                <ul>
                                    ...
                                    <li>하루에도 수십기가의 파일이 기록도 없이 USB에 카피되고, 프린터에 출력되고, 웹메일로 유출되고 있습니다. 소만사는 자동화된 분석툴로 인터넷 <br /> (웹메일, 웹하드, 메신저, SNS), 출력물, USB로 개인정보가 유출되는 현황을 정확하게 컨설팅할 수 있는 유일한 회사입니다.
                                    </li>
                                </ul>
                            </div>
                        </div>
