				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="information.jsp">회원가입</a></li>
						</ul></li>
				</ul>
				<%
					} else {
			...
			<form method="post" action="writeAction.jsp">
				...
				<table class="table table-striped"
					...
					<thead>
						<tr>
						 <th colspan="2"
								style="background-color: #81BEF7; text-align: center;">
								글쓰기 </th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							<td><input type="file" class="form-control" placeholder="파일 첨부" name="bbsUpload" maxlength="50"/></td>
						</tr>
					</tbody>
				</table>	
